export default {
 config:{cierre_inscripcion:'2026-09-27',final_fecha:'2026-10-24',final_ciudad:'Madrid',numero_finalistas:16},
 cities:[
  {id:1,name:'Valencia',date:'2026-10-03',registered:4,finalistSlots:2},
  ...
  {id:4,name:'Murcia',date:'2026-10-03',registered:1,finalistSlots:1},
  {id:5,name:'Oviedo',date:'2026-10-03',registered:0,finalistSlots:1},
  {id:6,name:'Palma de Mallorca',date:'2026-10-03',registered:3,finalistSlots:1},

  {id:7,name:'Madrid',date:'2026-10-10',registered:2,finalistSlots:3},
  {id:8,name:'Barcelona',date:'2026-10-10',registered:1,finalistSlots:1},
  {id:9,name:'Sevilla',date:'2026-10-08',registered:5,finalistSlots:1},
  {id:10,name:'Salamanca',date:'2026-10-10',registered:0,finalistSlots:1},
  {id:11,name:'Santiago',date:'2026-10-10',registered:0,finalistSlots:1},
  {id:12,name:'Vitoria-Gasteiz',date:'2026-10-10',registered:2,finalistSlots:1},
 ...
 teams:[
  ...
  ['Felipe I de Riga',4,'Sevilla'],
  ['Plus Ultra',5,'Valencia'],
  ['Ebro Liberal',4,'Vitoria-Gasteiz'],
  ['Valentia',5,'Valencia'],
